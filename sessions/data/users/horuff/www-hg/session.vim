...
map gb :FufBuffer
map gl :FufLine
map go :CtrlP /Users/horuff/foobar/short
map n nzz
map qq :q!
...
set cscopetag
set cscopeverbose
set errorformat=%*[^\"]\"%f\"%*\\D%l:\ %m,\"%f\"%*\\D%l:\ %m,%-G%f:%l:\ (Each\ undeclared\ identifier\ is\ reported\ only\ once,%-G%f:%l:\ for\ each\ function\ it\ appears\ in.),%-GIn\ file\ included\ from\ %f:%l:%c:,%-GIn\ file\ included\ from\ %f:%l:%c\\,,%-GIn\ file\ included\ from\ %f:%l:%c,%-GIn\ file\ included\ from\ %f:%l,%-G%*[\ ]from\ %f:%l:%c,%-G%*[\ ]from\ %f:%l:,%-G%*[\ ]from\ %f:%l\\,,%-G%*[\ ]from\ %f:%l,%f:%l:%c:%m,%f(%l):%m,%f:%l:%m,\"%f\"\\,\ line\ %l%*\\D%c%*[^\ ]\ %m,%D%*\\a[%*\\d]:\ Entering\ directory\ %*[`']%f',%X%*\\a[%*\\d]:\ Leaving\ directory\ %*[`']%f',%D%*\\a:\ Entering\ directory\ %*[`']%f',%X%*\\a:\ Leaving\ directory\ %*[`']%f',%DMaking\ %*\\a\ in\ %f,%f|%l|\ %m,%.%#PHP:\ %m\ (in\ %f\ on\ line\ %l)%.%#,%E%[0-9]%#.%m:%f?rev=%.%##L%l\ %.%#,%C%.%#
set expandtab
...
set modelines=0
set ruler
set runtimepath=~/.vim,~/.vim/bundle/vundle,~/.vim/bundle/vim-easymotion,~/.vim/bundle/FuzzyFinder,~/.vim/bundle/desert-warm-256,~/.vim/bundle/YouCompleteMe,/mnt/vol/engshare/admin/scripts/vim,/usr/share/vim/vimfiles,/usr/share/vim/vim74,/mnt/vol/engshare/admin/scripts/vim/after,~/.vim/bundle/vundle/,~/.vim/bundle/vundle/after,~/.vim/bundle/vim-easymotion/after,~/.vim/bundle/FuzzyFinder/after,~/.vim/bundle/desert-warm-256/after,~/.vim/bundle/YouCompleteMe/after
set scrolljump=5
set shiftwidth=2
set showmatch
set sidescroll=10
...
silent only
cd /data/users/horuff/www-hg
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +123 ~/.vimrc
badd +619 /data/users/horuff/www-hg/html/js/ads/powereditor/controller/ReachFrequencyFlowController.js
badd +191 flib/ads/services/reachfrequency/ReachFrequencyCurve.php
badd +102 flib/ads/services/reachfrequency/ReachFrequencyGK.php
badd +3 flib/ads/services/reachfrequency/ReachFrequencySuggestionHelper.php
badd +38 flib/ads/services/reachfrequency/RFSuggestionCacheHelper.php
badd +25 flib/ads/services/reachfrequency/ReachFrequencyPredictionConstants.php
badd +55 flib/ads/seals/url_to_page/AdLinkFbobjBatchMatcher.php
silent! argdel *
edit flib/ads/seals/url_to_page/AdLinkFbobjBatchMatcher.php
...
setlocal omnifunc=hackcomplete#Complete
setlocal path=
...
silent! normal! zE
let s:l = 55 - ((54 * winheight(0) + 56) / 113)
